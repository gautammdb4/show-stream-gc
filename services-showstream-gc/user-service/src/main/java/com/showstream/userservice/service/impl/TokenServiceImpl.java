...
import com.showstream.userservice.config.TokenConfigurationParameter;
...
import com.showstream.userservice.model.enums.TokenType;
...
//        invalidTokenService.checkForInvalidityOfToken(refreshTokenId);
    ...
    public UsernamePasswordAuthenticationToken getAuthentication(final String token) {
        ...
        Object roleObj = payload.get(TokenClaims.USER_ROLE.getValue());

        Set<RoleName> roles = ((List<String>) roleObj)
                .stream()
